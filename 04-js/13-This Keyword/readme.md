...
- Використовувати bind або обгортку-стрілку, щоб зберегти контекст при передачі методу як callback.

```// filepath: /Users/oleksandrvoichyshyn/Desktop/Main folder/IT/02 - TechInterviewPrep/04-js/13-This Keyword/readme.md
# this (ключове слово)
